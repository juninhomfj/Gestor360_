// Este arquivo consolida todas as definições de tipo do projeto.
...
export interface AppPreferences {
    hideValues: boolean;
    salesConfig: DashboardWidgetConfig;
    financeConfig: DashboardWidgetConfig;
}
...
export interface User {
    ...
    createdAt: string;
    createdBy?: string;
    // O passwordHash NUNCA é exposto ao frontend
}
